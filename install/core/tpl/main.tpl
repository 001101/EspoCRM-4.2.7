<form id="nav">
	<div class="panel-body">
			...
			<div class="col-md-12">
				<div align="center">
					<div class="content-img">
						<img class="devices" src="img/devices.png" alt="pluscrm">
					</div>
		...
		<div class="cell cell-website pull-right" align="right">
			<a target="_blank" href="http://pluscrm.eu/wp-content/downloads/installation.pdf" style="font-weight:bold;">{$langs['labels']['Installation Guide']}</a>
		</div>
