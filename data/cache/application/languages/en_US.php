...
return array (
  ...
  array (
    ...
    'messages' => 
    array (
      'upgradeVersion' => 'Your pluscrm will be upgraded to version <strong>{version}</strong>. This can take some time.',
      'upgradeDone' => 'Your pluscrm has been upgraded to version <strong>{version}</strong>.',
      'upgradeBackup' => 'We recommend to make a backup of your pluscrm files and data before upgrade.',
...
{optOutLink} &#8211; an unsubscribe link.',
  ...
  array (
    ...
    array (
      ...
      'assignmentEmailNotificationSubject' => 'pluscrm {entityType}: {Entity.name}',
...
(link name)[url]',
    ...
    array (
      ...
      'OpportunitiesByStage' => 'Bar Graph from data sample',
      'OpportunitiesByLeadSource' => 'Pie Graph from data sample',
 ...
 Only one email will be sent to a particular recipient during some period of time to prevent looping.',
  ...
  array (
    ...
    'help' => 
    array (
      'Google' => '<p><b>Obtain OAuth 2.0 credentials from the Google Developers Console.</b></p><p>Visit <a href="https://console.developers.google.com/project">Google Developers Console</a> to obtain OAuth 2.0 credentials such as a Client ID and Client Secret that are known to both Google and pluscrm application.</p>',
    ),
  ),
  'Job' => 
  array (
...
0 0 1 * * - on the first day of the month',
  ...
  array (
    ...
    array (
      ...
      'ldapCreateEspoUser' => 'Create User in pluscrm',
...
E.g. "userPrincipalName" or "sAMAccountName" for Active Directory, "uid" for OpenLDAP.',
  ...
  array (
    ...
    array (
      ...
      'accountInfoEmailSubject' => 'pluscrm User Access Info',
