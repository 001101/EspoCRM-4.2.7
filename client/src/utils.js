...
Espo.define('utils', [], function () {
    var Utils = Espo.utils = Espo.Utils = {
        ...
        isMobile: {
            ...
            any: function() {
                return (Espo.utils.isMobile.Android() || Espo.utils.isMobile.BlackBerry() || Espo.utils.isMobile.iOS() || Espo.utils.isMobile.Opera() || Espo.utils.isMobile.Windows());
            }
        }
    };
