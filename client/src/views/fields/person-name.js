...
Espo.define('views/fields/person-name', 'views/fields/varchar', function (Dep) {
    ...
    return Dep.extend({
        ...
        listTemplate: 'fields/person-name/list',
        
        listLinkTemplate: 'fields/person-name/list-link',
        ...
        data: function () {
            ...
            if (data.firstValue.length < 1 && data.lastValue.length < 1 || typeof data.salutationValue == 'undefined')
                data.simplifyName = true;
            return data;
        },
