...
Espo.define('views/fields/base', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        initInlineEdit: function () {
            ...
            var $editLink = $('<a href="javascript:" class="text-muted inline-edit-link hidden" data-original-title="" title=""><span class="pluscrm-pencil-circled"></span></a>');
            ...
            $cell.find('.control-label').append($editLink);
            ...
            $cell.on('mouseenter', function (e) {
                e.stopPropagation();
                if (this.disabled || this.readOnly || this.model.isInEdit()) {
                    return;
                }
                if (this.mode == 'detail') {
                    $editLink.removeClass('hidden');
                    $cell.addClass('inline-edit-hover');
                }
            }.bind(this)).on('mouseleave', function (e) {
                e.stopPropagation();
                if (this.mode == 'detail') {
                    $editLink.addClass('hidden');
                    $cell.removeClass('inline-edit-hover');
                }
            }.bind(this));
        },
        ...
        initElement: function () {
            ...
            if (this.mode == 'edit') {
                ...
                if (this.isInlineEdit) {
                    var i = this.$el.find('.form-control');
                    if (i.length == 1)
                        i.focus();  
                    else if (i.length > 1)
                        i[0].focus();   
        ...
        addInlineEditLinks: function () {
            var $cell = this.getCellElement();
            var $saveLink = $('<a href="javascript:" class="pull-right inline-save-link" title="' + this.translate('Update') + '"><span class="glyphicon glyphicon-ok"></span></a>');
            var $cancelLink = $('<a href="javascript:" class="pull-right inline-cancel-link" title="' + this.translate('Cancel') + '"><span class="glyphicon glyphicon-remove"></span></a>').css('margin-left', '8px');
        ...
        inlineEdit: function () {
            ...
            if (this.model.isInEdit())
                return;

            this.isInlineEdit = true;
            this.trigger('edit', this);
            this.setMode('edit');
            this.model.setInEdit();
