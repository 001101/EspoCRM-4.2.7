...
Espo.define('Views.Record.ListPagination', 'View', function (Dep) {
    ...
    return Dep.extend({
        ...
        data: function () {
            ...
            var maxSize = parseInt(this.collection.maxSize);
            var sizingArray = [20,50,100];
            //if (sizingArray.indexOf(maxSize) == -1)
            //    sizingArray.unshift(maxSize);
                
            console.log("refresh",maxSize);
            return {
