...
Espo.define('views/record/base', ['view', 'view-record-helper'], function (Dep, ViewRecordHelper) {
    ...
    return Dep.extend({
        ...
        save: function (callback) {
            ...
            console.log("beforesave attributes", beforeSaveAttributes, Espo.Utils.cloneDeep(beforeSaveAttributes), data);
            var attrs = false;
            if (model.isNew()) {
                attrs = data;
            } else {
