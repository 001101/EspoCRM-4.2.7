...
Espo.define('view-helper', [], function () {
    ...
    _.extend(ViewHelper.prototype, {
        ...
        _registerHandlebarsHelpers: function () {
            ...
            Handlebars.registerHelper('ifNotEmpty', function (object, options) {
            ...
            Handlebars.registerHelper('ifEmpty', function (object, options) {
                if (object === null && typeof object === 'undefined') {
                    return options.fn(this);
                }
                return options.inverse(this);
            ...
            Handlebars.registerHelper('ifPropExists', function (object, property, options) {
            ...
            Handlebars.registerHelper('ifPropEqualsNot', function (object, property, value, options) {
                if (object[property] != value) {
                    return options.fn(this);
                }
                return options.inverse(this);
            ...
            Handlebars.registerHelper('ifHasAttr', function (model, attr, options) {
                if (model.has(attr)) {
                    return options.fn(this);
                }
                return options.inverse(this);
            ...
            Handlebars.registerHelper('composeCssName', function (name) {
                return Espo.Utils.composeCssName(name);
            });
        }
    });
