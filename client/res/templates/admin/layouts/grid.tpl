    ...
    <li>
        <header>
            ...
            <span class="label label-black">
                ...
                %>
                    <input type="checkbox" name="is-always-present" checked> 
                <%            
                    } else {
                %>
                    <input type="checkbox" name="is-always-present"> 
                <%    
                    }
                %>   
             {{translate 'Always visible' scope='Admin'}}</span>
