<div class="detail" id="{{id}}">
    ...
    <div class="row">
        ...
        <div class="{{#if isWide}} col-md-12{{else}}{{#if hasSide}}{{#if isSmall}} col-md-7{{else}} col-md-8{{/if}}{{else}} col-md-12{{/if}}{{/if}}">
        {{#if hasSide}}
            <div class="middle">
                {{{menu}}}
        ...
        {{#if hasSide}}
            <div class="side detail-side {{#if isWide}} col-md-12{{else}}{{#if isSmall}} col-md-5{{else}} col-md-4{{/if}}{{/if}}">
            {{{side}}}
            </div>
        {{/if}}
