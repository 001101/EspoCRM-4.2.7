...
<div class="list">
{{#ifPropExists listDefinitions 'scrollTable'}}{{#ifPropEquals listDefinitions 'scrollTable' true}} 
<div class="table-responsive">
{{/ifPropEquals}}{{/ifPropExists}}
    <table class="table" {{#each tableAttributes}}data-{{toDom this}}="{{prop ../listDefinitions this}}" {{/each}}>
        {{#if header}}
        <thead>
            <tr>
                {{#if checkboxes}}
