...
<div class="row search-row">
    <div class="form-group col-md-6 col-sm-8 col-xs-9">
    ...
    <div class="form-group col-md-6 col-sm-4 col-xs-3">
        <div class="btn-group">
            <button type="button" class="btn btn-default" data-action="reset" title="{{translate 'Reset search'}}">
                <span class="glyphicon glyphicon-remove-circle"></span>
            </button>
            <button type="button" class="btn btn-default dropdown-toggle add-filter-button" data-toggle="dropdown" tabindex="-1" title="{{translate 'Filter search'}}">
