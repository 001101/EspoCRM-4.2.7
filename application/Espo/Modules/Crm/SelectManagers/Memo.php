...
class Memo extends \Espo\Core\SelectManagers\Base
{
    protected function filterType($value,&$result)
    {
        $typeOptions = $this->metadata->get("entityDefs.{$this->entityType}.fields.type.options", []);
        if (in_array($value,$typeOptions)) {
